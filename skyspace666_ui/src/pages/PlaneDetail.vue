					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updatePlane()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Planes = true">Add</base-button>
								              <modal :show.sync="modal2Planes">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Plane Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PlaneId" type="text" placeholder="Enter PlaneId" v-model="planeDetails.planeId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Model</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Model" type="text" placeholder="Enter Model" v-model="planeDetails.model"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Capacity</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Capacity" type="text" placeholder="Enter Capacity" v-model="planeDetails.capacity"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Manufacturer</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Manufacturer" type="text" placeholder="Enter Manufacturer" v-model="planeDetails.manufacturer"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updatePlane() {
      ...
      const jsonData = JSON.stringify(this.planeDetails);
      const res = await PlaneService.update(jsonData);
...
//        this.getAllPlanes();
    ...
    async getPlaneDetails() {
      try {
			let response = await PlaneService.get(this.planeId);
			this.planeDetails = response.data;
